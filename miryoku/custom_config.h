...
&kp TAB,           &kp N1,            &kp N2,            &kp N3,            &kp N4,            &kp N5,            XXX,               XXX,               XXX,               XXX,                \
XXX,               XXX,               &kp Q,             &kp W,             XXX,               XXX,               XXX,               XXX,               XXX,               XXX,                \
XXX,               &kp LSHFT,         &kp A,             &kp S,             &kp D,             &kp F,             XXX,               XXX,               XXX,               XXX,                \
...
&kp TAB,           &kp N6,            &kp N7,            &kp N8,            &kp N9,            &kp N0,            XXX,               XXX,               XXX,               XXX,                \
XXX,               XXX,               &kp Q,             &kp W,             XXX,               XXX,               XXX,               XXX,               XXX,               XXX,                \
XXX,               &kp LSHFT,         &kp A,             &kp S,             &kp D,             &kp F,             XXX,               XXX,               XXX,               XXX,                \
U_NP,              U_NP,              &kp C,             &kp SPACE,         &trans,            XXX,               XXX,               XXX,               U_NP,              U_NP

// Modify the base layer mapping to include the toggle DOOM key
...
XXX  K00  K01  K02  K03  K04       K05  K06  K07  K08  K09  &tog U_DOOM \
